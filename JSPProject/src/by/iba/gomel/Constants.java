...
public class Constants {
    ...
    public static final int    ONE_KILOBYTE_TO_BYTE                              = 1024;
    ...
    public static final String PARAMETER_MAX_SIZE                                = "maxSizeError";
    ...
    public static final String PARAMETER_PATH_FILE                               = "pathFile";
    ...
    public static final String PARAMETER_CHECKING_FULL_NAME                      = "checkingFullName";
    public static final String PARAMETER_CHECKING_ADDRESS                        = "checkingAddress";
    public static final String PARAMETER_CHECKING_PHONE_NUMBER                   = "checkingPhoneNumber";
    public static final String PARAMETER_CHECKING_MAIL                           = "checkingMail";
    ...
    public static final String MESSAGE_REGISTRATION_INCORRECT_LOGIN_ERROR        = "message.registrationincorrectloginerror";
    ...
    public static final String MESSAGE_DELETING_USER_SUCCESS                     = "message.successUserDeleting";
    public static final String MESSAGE_DELETING_ERROR                            = "message.errorDeleting";
    public static final String MESSAGE_DELETING_USER_ERROR                       = "message.errorUserDeleting";
    public static final String MESSAGE_MAX_SIZE_ERROR                            = "message.maxSizeError";
    public static final String MESSAGE_FULL_NAME_ERROR                           = "message.errorFullName";
    public static final String MESSAGE_ADDRESS_ERROR                             = "message.errorAddress";
    public static final String MESSAGE_PHONE_NUMBER_ERROR                        = "message.errorPhoneNumber";
    public static final String MESSAGE_MAIL_ERROR                                = "message.errorMail";
    ...
    public static final String INIT_PARAMETER_MAIN_PAGE                          = "MAIN_PAGE";
    public static final String PATTERN_LOGIN                                     = "^\\w+$";
    public static final String PATH_EDIT_BD_PROFILE                              = "edit_bd_profile";
    ...
    public static final String TEMPORARY_NAME_FOLDER                             = "temp";

    public static final String REQUEST_DB_ADD_RECORD                             = "INSERT INTO VLADY.\"PhoneBook\" (\"fullName\", \"address\", \"phoneNumber\", \"mail\", \"birthDate\", \"photo\") VALUES (?,?,?,?,?,?)";
    ...
    public static final String REQUEST_DB_EDIT_RECORD                            = "UPDATE VLADY.\"PhoneBook\" SET \"fullName\"=?, \"address\"=?, \"phoneNumber\"=?, \"mail\"=?, \"birthDate\"=?,\"photo\"=? WHERE VLADY.\"PhoneBook\".\"item\"=?";
    ...
    public static final String REQUEST_DB_GET_RECORDS_ALL_COLUMNS_FIRST_PART     = "SELECT \"item\",\"fullName\",\"address\",\"phoneNumber\",\"creationDate\",\"mail\",\"birthDate\",\"photo\"  FROM VLADY.\"PhoneBook\" WHERE LOWER(\"fullName\") LIKE '%";
    ...
    public static final String REQUEST_DB_GET_RECORDS_CERTAIN_COLUMN_FIRST_PART  = "SELECT \"item\",\"fullName\",\"address\",\"phoneNumber\",\"creationDate\",\"mail\",\"birthDate\",\"photo\" FROM VLADY.\"PhoneBook\" WHERE LOWER(\"";
    ...
    public static final String REQUEST_DB_GET_ALL_RECORDS_FIRST_PART             = "SELECT \"item\",\"fullName\",\"address\",\"phoneNumber\",\"creationDate\",\"mail\",\"birthDate\",\"photo\" FROM VLADY.\"PhoneBook\" LIMIT ";
    public static final String REQUEST_DB_GET_ALL_RECORDS_SECOND_PART            = ",30 ";

    public static final String REG_FULL_NAME                                     = "^[ a-zA-Zа-яА-ЯёЁ]+$";
